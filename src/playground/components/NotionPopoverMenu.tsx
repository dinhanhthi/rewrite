...
import RewritePopoverOption from '../../contentScript/components/RewritePopoverOption'
      ...
      <div className="notion-playground" style={{ paddingTop: '6px', paddingBottom: '6px' }}>
        ...
        >
          ...
          >
            ...
            <div
              style={{ marginLeft: 'auto', marginRight: '12px', minWidth: '0px', flexShrink: '0' }}
            >
              <span
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              style={{ marginLeft: '6px', marginRight: '12px', minWidth: '0px', flex: '1 1 auto' }}
            >
              <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                Turn into
              </div>
