...
export default function FormatSelectedPlayground() {
  ...
  const [inputText, setInputText] = React.useState(
    types.find(type => type.id === defaultType)!.html
  )

  const handleOnSelectChange = (value: string) => {
    setInputText(types.find(type => type.id === value)!.html)
  }
      ...
      <div className="flex flex-col flex-1 h-full gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="text-sm">
            ☝{' '}
            <span className="italic">That's what looks like after we select texts / blocks in Notion.</span>
          </div>
        </div>
      </div>
      <div className="flex flex-col flex-1 w-full h-full gap-8">
        <div className="flex flex-col w-full gap-2 h-fit max-h-1/3">
          <div className='font-medium'>Styled</div>
          <div
            className="flex-1 p-4 overflow-auto text-sm border rounded-md dat-scrollbar dat-scrollbar-small"
            dangerouslySetInnerHTML={{ __html: inputText }}
          ></div>
        </div>
        <div className="flex flex-col w-full gap-2 h-2/3">
          <div className='font-medium'>Formatted</div>
          <div className="flex-1 p-4 overflow-auto text-sm border rounded-md dat-scrollbar dat-scrollbar-small">
            {formatSelectedText(inputText)}
          </div>
        </div>
      </div>
    </div>
...
const types: {
  ...
  {
    id: 'ol-select',
    name: 'mixed ol / ul (selected)',
    html: '<div data-block-id="c1fe63b5-347d-4ea0-9a0b-4bd7edbab23a" class="notion-selectable notion-numbered_list-block" style="width: 100%; max-width: 722px; margin-top: 1px; margin-bottom: 1px;"><div style="display: flex; align-items: flex-start; width: 100%; padding-left: 2px; color: inherit; fill: inherit;"><div style="flex: 1 1 0px; min-width: 1px; display: flex; flex-direction: column;"><div style="display: flex;"><div class="notranslate" spellcheck="true" placeholder="List" data-content-editable-leaf="true" style="max-width: 100%; width: 100%; white-space: pre-wrap; word-break: break-word; caret-color: rgb(55, 53, 47); padding: 3px 2px; text-align: left;" contenteditable="true">Thu nghiem</div><div style="position: relative; left: 0px;"></div></div><div data-block-id="8d307b28-890c-4a4d-8050-647c5bca2d96" class="notion-selectable notion-bulleted_list-block" style="width: 100%; max-width: 100%; margin-top: 2px; margin-bottom: 1px;"><div style="display: flex; align-items: flex-start; width: 100%; padding-left: 2px; color: inherit; fill: inherit;"><div contenteditable="false" class="pseudoSelection" data-content-editable-void="true" data-text-edit-side="start" style="user-select: none; --pseudoSelection--background: transparent; margin-right: 2px; width: 24px; display: flex; align-items: center; justify-content: center; flex-grow: 0; flex-shrink: 0; min-height: calc(1.5em + 6px);"><div class="pseudoBefore" style="font-size: 1.5em; line-height: 1; margin-bottom: 0px; --pseudoBefore--fontFamily: Arial; --pseudoBefore--content: &quot;•&quot;;"></div></div><div style="flex: 1 1 0px; min-width: 1px; display: flex; flex-direction: column;"><div style="display: flex;"><div class="notranslate" spellcheck="true" placeholder="List" data-content-editable-leaf="true" style="max-width: 100%; width: 100%; white-space: pre-wrap; word-break: break-word; caret-color: rgb(55, 53, 47); padding: 3px 2px; text-align: left;" contenteditable="true">What a beautiful day</div><div style="position: relative; left: 0px;"></div></div><div data-block-id="8d307b28-890c-4a4d-8050-647c5bca2d96" class="notion-selectable notion-bulleted_list-block"></div></div></div></div><div data-block-id="f7768332-aab6-400e-986b-cf04cb9ac9a9" class="notion-selectable notion-bulleted_list-block" style="width: 100%; max-width: 100%; margin-top: 1px; margin-bottom: 0px;"><div style="display: flex; align-items: flex-start; width: 100%; padding-left: 2px; color: inherit; fill: inherit;"><div contenteditable="false" class="pseudoSelection" data-content-editable-void="true" data-text-edit-side="start" style="user-select: none; --pseudoSelection--background: transparent; margin-right: 2px; width: 24px; display: flex; align-items: center; justify-content: center; flex-grow: 0; flex-shrink: 0; min-height: calc(1.5em + 6px);"><div class="pseudoBefore" style="font-size: 1.5em; line-height: 1; margin-bottom: 0px; --pseudoBefore--fontFamily: Arial; --pseudoBefore--content: &quot;•&quot;;"></div></div><div style="flex: 1 1 0px; min-width: 1px; display: flex; flex-direction: column;"><div style="display: flex;"><div class="notranslate" spellcheck="true" placeholder="List" data-content-editable-leaf="true" style="max-width: 100%; width: 100%; white-space: pre-wrap; word-break: break-word; caret-color: rgb(55, 53, 47); padding: 3px 2px; text-align: left;" contenteditable="true">Another</div><div style="position: relative; left: 0px;"></div></div><div data-block-id="f7768332-aab6-400e-986b-cf04cb9ac9a9" class="notion-selectable notion-bulleted_list-block"></div></div></div></div></div></div></div><div data-block-id="c948ce55-bf0d-42b9-855c-d8f1cc99fdd0" class="notion-selectable notion-numbered_list-block" style="width: 100%; max-width: 722px; margin-top: 1px; margin-bottom: 1px;"><div style="display: flex; align-items: flex-start; width: 100%; padding-left: 2px; color: inherit; fill: inherit;"><div contenteditable="false" class="pseudoSelection" data-content-editable-void="true" data-text-edit-side="start" style="user-select: none; --pseudoSelection--background: transparent; margin-right: 2px; width: unset; display: flex; align-items: center; justify-content: center; flex-grow: 0; flex-shrink: 0; min-height: calc(1.5em + 6px);"><span class="pseudoBefore" style="--pseudoBefore--content: &quot;2.&quot;; width: 24px; text-align: center; white-space: nowrap;"></span></div><div style="flex: 1 1 0px; min-width: 1px; display: flex; flex-direction: column;"><div style="display: flex;"><div class="notranslate" spellcheck="true" placeholder="List" data-content-editable-leaf="true" contenteditable="true" style="max-width: 100%; width: 100%; white-space: pre-wrap; word-break: break-word; caret-color: rgb(55, 53, 47); padding: 3px 2px; text-align: left;">Item</div><div style="position: relative; left: 0px;"></div></div><div data-block-id="cddc86e5-aea0-4b7e-9ff7-be1b9e353713" class="notion-selectable notion-bulleted_list-block" style="width: 100%; max-width: 100%; margin-top: 2px; margin-bottom: 0px;"><div style="display: flex; align-items: flex-start; width: 100%; padding-left: 2px; color: inherit; fill: inherit;"><div contenteditable="false" class="pseudoSelection" data-content-editable-void="true" data-text-edit-side="start" style="user-select: none; --pseudoSelection--background: transparent; margin-right: 2px; width: 24px; display: flex; align-items: center; justify-content: center; flex-grow: 0; flex-shrink: 0; min-height: calc(1.5em + 6px);"><div class="pseudoBefore" style="font-size: 1.5em; line-height: 1; margin-bottom: 0px; --pseudoBefore--fontFamily: Arial; --pseudoBefore--content: &quot;•&quot;;"></div></div><div style="flex: 1 1 0px; min-width: 1px; display: flex; flex-direction: column;"><div style="display: flex;"><div class="notranslate" spellcheck="true" placeholder="List" data-content-editable-leaf="true" contenteditable="true" style="max-width: 100%; width: 100%; white-space: pre-wrap; word-break: break-word; caret-color: rgb(55, 53, 47); padding: 3px 2px; text-align: left;">You are awesome</div></div></div></div></div></div></div></div>'
  },
  {
    id: 'ol',
    name: 'ol (block selected)',
  ...
  {
    id: 'formated-text',
    name: 'formated text (selected)',
    html: 'Test with <span style="font-weight:600" data-token-index="1" class="notion-enable-hover">bold</span> and <span style="font-style:italic" data-token-index="3" class="notion-enable-hover">italic</span> and also <span style="color:inherit;border-bottom:0.05em solid;word-wrap:break-word" data-token-index="5" class="notion-enable-hover">underline</span> and <span style="font-family:&quot;SFMono-Regular&quot;, Menlo, Consolas, &quot;PT Mono&quot;, &quot;Liberation Mono&quot;, Courier, monospace;line-height:normal;background:rgba(135,131,120,.15);color:#EB5757;border-radius:4px;font-size:85%;padding:0.2em 0.4em" data-token-index="7" spellcheck="false" class="notion-enable-hover">code</span> and also <span style="text-decoration:line-through" data-token-index="9" class="notion-enable-hover">strikethrough</span>. We can also test with <span style="color:inherit;border-bottom:0.05em solid;word-wrap:break-word;text-decoration:line-through;font-style:italic;font-weight:600" data-token-index="11" class="notion-enable-hover">combind all of them</span>. asdasdsad'
  },
  {
    id: 'plain-text',
    name: 'plain text (selected)',
    html: 'This is plain text without any formated'
  },
  {
    id: 'code',
    name: 'code (block selected)',
  ...
  },
  {
    ...
    name: 'multiple paragraphs (block selected)',
