...
export default function RewriteMenu(props: RewriteMenuProps) {
  return (
    <div className={cn(props.className, 'flex flex-col p-1.5 text-sm')}>
      <div className="group">
        <div className="flex flex-row items-center gap-4 py-1.5 pl-2 rounded-sm hover:cursor-pointer group-hover:bg-gray-100">
      ...
      <div className="group">
        <div className="flex flex-row items-center gap-4 py-1.5 pl-2 pr-6 rounded-sm hover:cursor-pointer group-hover:bg-gray-100">
