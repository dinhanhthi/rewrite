...
type RewriteEditorWrapperProps = {
  showRewriteEditor: boolean
  setShowRewriteEditor: React.Dispatch<React.SetStateAction<boolean>>
  contentClassName?: string
}

export default function RewriteEditorWrapper(props: RewriteEditorWrapperProps) {
                ...
                <div className="overflow-y-auto dat-scrollbar dat-scrollbar-small">
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      ...
                      __html: '<span style="font-weight: 500;"></span>w thu to mobile use, try to thu tstrap'
                    }}
                  ></div>
                </div>
              </div>
